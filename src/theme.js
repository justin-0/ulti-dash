...
export const themeSettings = (mode) => {
	...
	// Returns our theme object, palette and typography customised
	return {
		palette: {
			mode: mode,
			...(mode === 'dark'
				? {
						/* Dark Mode Palette - Colors returns object */
						primary: {
...
export const useMode = () => {
	...
	const theme = useMemo(() =>
		// Create MUI theme with theme settings and current mode state
		createTheme(themeSettings(mode), [mode])
	);

	// return an array to use with custom hook useMode
